...
local function build(c, opts)
  ...
  return {
    ...
    FloatBorder = { fg = c.bg_panel, bg = float_bg },
    ...
    TelescopeBorder = { fg = c.chrome_line, bg = float_bg },
    TelescopeTitle = { fg = c.fg, bold = true },
    TelescopePromptNormal = { fg = c.fg, bg = c.bg_chrome },
    TelescopePromptBorder = { fg = c.bg_chrome, bg = c.bg_chrome },
    TelescopePromptTitle = { fg = c.comment, bg = c.bg_chrome, bold = true },
    TelescopeResultsTitle = { fg = c.bg_chrome, bg = c.bg_chrome },
    TelescopePreviewTitle = { fg = c.comment, bg = float_bg, bold = true },
    TelescopePromptPrefix = { fg = c.cyan },
    TelescopeSelection = { fg = c.fg, bg = c.bg_sel },
    TelescopeSelectionCaret = { fg = c.cyan, bg = c.bg_sel },
    ...
    FzfLuaBorder = { fg = c.chrome_line, bg = float_bg },
    ...
    WhichKeyBorder = { fg = c.chrome_line, bg = float_bg },
    WhichKeyTitle = { fg = c.fg, bold = true },

    NoiceCmdlinePopup = { fg = c.fg, bg = float_bg },
    NoiceCmdlinePopupBorder = { fg = c.chrome_line, bg = float_bg },
    NoiceCmdlineIcon = { fg = c.cyan },
    NoiceConfirmBorder = { fg = c.chrome_line, bg = float_bg },
    ...
    SnacksWinBar = { fg = c.fg, bg = c.bg_chrome },
    SnacksPickerBorder = { fg = c.chrome_line, bg = float_bg },
    SnacksPickerPrompt = { fg = c.cyan, bg = c.bg_chrome },
    SnacksPickerInput = { fg = c.fg, bg = c.bg_chrome },
